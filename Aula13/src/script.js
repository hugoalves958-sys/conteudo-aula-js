...
const frutas = ["Manga", "Banana", "Abacaxi","Acerola"];
...
let adicionarItemFrutas = frutas.push("Mamão");
console.log(frutas);
...
// let copialItems = frutas.copyWithin(2, 0);
// // console.log(frutas);
...
const listaNumeros2 = [1,2,3,4,5,6,7,9,10];
...
console.log(frutas);
const novaListaFrutas = frutas.splice(2, 2, "Pêra", "Carambola");
console.log(frutas);
